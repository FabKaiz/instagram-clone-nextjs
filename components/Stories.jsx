    ...
    <div className="flex space-x-3 p-4 bg-white mt-8 border-gray-200 border rounded-sm overflow-x-scroll scrollbar-thin scrollbar-thumb-black">
      {session && (
        <div className="relative">
          ...
          />
          <span class="absolute right-[2px] top-[32px] border-2 border-white inline-flex items-center justify-center px-[4.4px] pt-[0px] text-md font-bold leading-none text-red-100 bg-blue-500 rounded-full">
